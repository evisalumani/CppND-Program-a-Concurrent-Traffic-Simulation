...
T MessageQueue<T>::receive()
{
    ...
    // Interface of std::dequeue (https://en.cppreference.com/w/cpp/container/deque)
    // Access the first element in queue (to be returned later) and remove it from queue
